...
<head>
    ...
    <div class="introduction">
        <img src="img/aiti.png" alt="aiti logo" class="animate__animated animate__flipInX" style="--animate-duration: 1.7s;">
        <h1 class="logo-intro">
            <span class="logo-parts">Aplicaciones</span>
            <span class="logo-parts">Integrales</span>
            <span class="logo-parts">en</span>
            <span class="logo-parts">TI</span>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="title-container">
                        <div class="title-mask-in">
                            <h1 class="title-content-in">
                                <span class="title-highlight-in">innovación en TI</span>
                            </h1>
                        </div>
                    </div>
                </div>
	...
	<script type="text/javascript">
        ...
        <section class="contenido" id="blog">
            <ul class="section-content list-unstyled">
                <li class="blog-right">
                    <h2 class="text-end" style="color:  #073E63">Blog y Tendencias</h2>
                    <p>Conoce las tendencias en TI o lee algún articulo que te resulte útil.
                    </p>
                    <div class="text-end" style="padding: 10px;">
                        <a class="btn btn-primary " href="blog.php" role="button"> Visita el blog completo </a>
                    </div>
                    <img class="img-contenido" src="img/blog.gif">
                </li>
                <li class="blog-left">
